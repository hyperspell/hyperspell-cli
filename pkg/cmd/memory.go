...
var memoriesUpdate = cli.Command{
	...
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:      "source",
			Usage:     `Allowed values: "reddit", "notion", "slack", "google_calendar", "google_mail", "box", "dropbox", "github", "google_drive", "vault", "web_crawler", "trace", "microsoft_teams", "gmail_actions", "granola", "fathom", "fireflies", "linear", "hubspot", "salesforce", "coda", "lightfield".`,
			Required:  true,
			PathParam: "source",
		},
		&requestflag.Flag[string]{
