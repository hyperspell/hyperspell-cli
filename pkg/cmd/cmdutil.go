...
import (
	...
	"github.com/hyperspell/hyperspell-cli/internal/jsonview"
...
func getDefaultRequestOptions(cmd *cli.Command) []option.RequestOption {
	opts := []option.RequestOption{
		option.WithHeader("User-Agent", fmt.Sprintf("Hyperspell/CLI %s", Version)),
	...
	if cmd.IsSet("user-id") {
		opts = append(opts, option.WithUserID(cmd.String("user-id")))
	}
